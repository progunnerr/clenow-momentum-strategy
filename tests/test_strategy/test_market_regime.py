...
class TestShouldTradeMomentum:
    ...
    def test_should_trade_momentum_bullish(self):
        ...
        market_regime = {"regime": "bullish", "trading_allowed": True, "ma_period": 200}
    ...
    def test_should_trade_momentum_bearish(self):
        ...
        market_regime = {"regime": "bearish", "trading_allowed": False, "ma_period": 200}
    ...
    def test_should_trade_momentum_error(self):
        ...
        market_regime = {"regime": "unknown", "trading_allowed": False, "error": "Network error"}
